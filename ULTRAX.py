...
try:
  ...
  pass
from MONSTERX2 import devs, id, ID
...
ULTRAX = "[MONSTER X](https://t.me/MONSTERXChAT)"
VERSION = "0.0.1"
...
ID = ID
id = id
REPO = "[MONSTER X BOT](https://github.com/MONSTER-BOT/MONSTER-X)"
